	...
	<div class="row justify-content-center">
		<div class="cold-md-3 col-sm-6 col-xs-12 row-container">
			<form method="POST" enctype="multipart/form-data">
				...
				<label>Character Name: </label> <input class="form-control" type="text" name="name" required value="<?=$result['name']?>">
				...
				<label>Story: </label> 
					<textarea name="story" class="form-control"><?=$result['story']?></textarea>
				<label>Status: </label>
